...
public class HelloWorld {
    ...
    public void testCreate() throws IOException {
        ...
        String indexPath = "/home/lyy/index";
        File file=new File(indexPath);
//        System.out.println(Files.isDirectory(Paths.get(indexPath)));
//        Files.isDirectory(Paths.get("/home/桌面/index"));
...
//        Analyzer analyzer = new StandardAnalyzer();
    ...
    public void testSearch() throws IOException, ParseException {
        ...
        String indexPath = "/home/lyy/桌面/index";
        Analyzer analyzer = new IKAnalyzer(true);
        //Analyzer analyzer = new IKAnalyzer(true);
        ...
        Query query = parser.parse(queryStr);
         ...
         //TermQuery将查询条件当成是一个固定的词（标准分词器使用）
        //Query query = new TermQuery(new Term("url", "http://www.edu360.cn/a10010"));
        //在【索引】中进行查找
        TopDocs topDocs = indexSearcher.search(query, 10/*查找出的前10个*/);
...
//        BooleanClause.Occur.MUST//两者均满足
//        BooleanClause.Occur.SHOULD//两者满足一可
